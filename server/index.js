...
const {getTasks, addTask, editTask, deleteTask, getTaskById, completeTask, unCompleteTask, completedTasks} = require('./controllers/tasksController.ts');
...
app.put('/api/task/completeTask/:task_id', completeTask)
